...
const defaultCVData = {
  "layout": {
    ...
    "footerText": "Markus Waldheim — Senior IT-Consultant & DevSecOps Experte",
    "previewMode": "a4",
    "visibleSections": {
      "profile": true,
      "workExperience": true,
  ...
  "personal": {
    ...
    "email": "kontakt@waldheim.dev",
    "phone": "+49 821 1234567",
    "location": "Augsburg, Deutschland",
    "website": "waldheim.dev",
    "github": "github.com/Waldheim-dev",
    "linkedin": "linkedin.com/in/markus-waldheim-03827a312",
  ...
  "certifications": [
    ...
    },
    {
      ...
      "authority": "IHK Schwaben (Augsburg)",
      "date": "2021"
    }
  ],
  "workExperience": [
    {
      ...
      "company": "Waldheim.dev, Augsburg/München",
      "date": "Seit Feb 2022",
      "details": [
        ...
        "Entwicklung und Instandhaltung eigener SaaS-Branchenlösungen: Silvacore (WEG- & Mietverwaltung), Ecodrive (Fahrzeugkosten-Optimierung) und Socialverse (KI-basiertes Social Media Management)."
      ]
    },
    {
      "role": "Senior IT-Consultant",
      "company": "InterFace AG, München",
      "date": "Seit Jul 2022",
      "details": [
        ...
        "Projekte: DevSecOps-Automatisierung für kommunale Software (München), inhouse DevService-Teamunterstützung, behördlicher Freigabeprozess (Nürnberg) und Diabetesstudien-Verwaltung (München)."
      ]
    },
    {
      "role": "Fullstack-Entwickler & Teamleiter / Ausbilder",
      "company": "SEWOBE AG, Augsburg",
      "date": "Feb 2015 — Jul 2022",
      "details": [
        "Entwicklung und Modularisierung eines PHP-basierten ERP/CRM-Systems für Verbände und Parteien.",
  ...
  "education": [
    {
      ...
      "institution": "SEWOBE AG, Augsburg (Abschluss vor der IHK Augsburg)",
      "date": "2015 — 2018"
    }
  ],
  "methodsAndTools": [
  ...
  "hobbies": [
    "🛠️ Open-Source-Entwicklung (z. B. WetterApp, Amigo Framework, Netbox-Plugins)",
    "🎓 Wissensvermittlung und Mentoring",
    "⚡ Cloud Architecture & Tech-Experimente"
  ],
  "projects": [
    {
      "title": "K8s Chaos Battleship (Cloudland 2026)",
      "duration": "2026",
      "role": "Rolle: Core Developer & Architect",
      "description": "Konzeption eines interaktiven Chaos Engineering Experiments für die Tech-Konferenz Cloudland, aufgebaut mit Go, Kubernetes und FluxCD zur anschaulichen Demonstration resilienter Infrastrukturen.",
      "technologies": ["Go", "Kubernetes", "FluxCD", "Docker", "DevSecOps"]
    },
    {
      "title": "Silvacore SaaS Plattform",
      "duration": "2024 — 2025",
    ...
    {
      "title": "Musikverein Obermeitingen e.V. Webportal",
      "duration": "2023 — 2024",
      "role": "Rolle: Web-Designer & Core Committer",
      "description": "Modernisierung des gesamten Vereinsauftritts mit Astro.js und Tailwind CSS zur Erreichung optimaler Ladezeiten (Lighthouse-Score 100/100) und moderner UI.",
      "technologies": ["Astro.js", "Tailwind CSS", "Vite", "SEO Optimierung"]
    }
  ],
  "openSource": [
    {
      "title": "Amigo: Autonomes Multi-Agenten-Framework (Go)",
    ...
    {
      "title": "Netbox Ausgabeschein-Generator",
    ...
    },
    {
      "title": "WetterApp",
      "role": "Creator",
      "description": "Eine hoch-performante, quelloffene Wetter-App mit Multi-Provider-Unterstützung (wie DWD und OpenWeather) zur Live-Aggregation meteorologischer Messdaten.",
      "technologies": ["Astro.js", "Tailwind CSS", "TypeScript", "REST APIs"]
    },
    {
      "title": "Obsidian Gemini Agent",
      "role": "Creator",
      "description": "Ein AI Knowledge-Management Agent als Obsidian-Plugin zur automatischen Verlinkung, semantischen Strukturierung und Analyse persönlicher Notizen.",
      "technologies": ["TypeScript", "Gemini API", "Vector Embeddings", "Obsidian API"]
    },
    {
